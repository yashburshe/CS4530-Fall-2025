...
You should plan on spending the next two weeks (from Oct 8 until Oct 22) in a "Sprint -1" in which you will undertake organizational and research tasks to help you decide on a project and formulate your plan.
...
Your user stories should cover the key behavior or qualities that your features will provide. User stories are written to descrive high-level requirements.
...
Your project plan must include atleast 3 essetial or desirable user stories. You suggest that you should have no less than 10-12 conditions of satisfaction and your essential COS be twice the number of desirable COS. Your problem statement and description of user stories and conditions of satisfaction should be between 4-6 pages. Your testable behaviors should be between 2-4 pages.
